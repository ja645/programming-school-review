...
<body>
  <div id="has-no-header" class="container-fluid p-0">
    ...
    <input type="hidden" name="token" value="{{ $request->route('token') }}">
      ...
      <input name="password_confirmation" type="password" class="feedback-input" value="__('Confirm Password')" placeholder="確認用パスワード" />
      <input type="submit" value="パスワードを変更" style="margin-bottom: 15px;"/>
    </form>

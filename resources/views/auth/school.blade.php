  ...
  <div class="container-fluid school-container">
    <div class="col-11 mx-auto school-head-card">
      <div class="row school-head">
        ...
        <div class="school-name col text-sm-start text-center px-0">{{ $school->school_name }}<span id="like"><like-component :prop-user-id="@json(Auth::id())" :prop-school-likes="@json($school->likes->count())"></like-component></span></div>
      </div>
      <div class="row">
